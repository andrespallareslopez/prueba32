  ...
  _createClass(mysearch, [{
    ...
    value: function initevent(options, id) {
      ...
      datalist = new controls.UXSearchList({
        ...
        data: function (id) {
          if (id == "search01") return datos;else if (id == "search02") return { mesas: _listInMemory.mesas };
        }(id),

        textTemplate: function (id) {
          if (id == "search01") return cadenadatagruposstring;else if (id == "search02") return cadenadatamesas;
        }(id),
